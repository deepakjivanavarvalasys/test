...
@section('content')
    ...
    <div id="modalRegion" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title h4" id="modal-heading">Add new region</h5>
                    ...
                    <form id="modal-role-form">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <label for="name">Region Abbreviation</label>
                                <input type="text" class="form-control btn-square" id="abbreviation" name="abbreviation" placeholder="Enter abbreviation name" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <label for="name">Region Name</label>
                                <input type="text" class="form-control btn-square" id="name" name="name" placeholder="Enter region name" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 form-group">
