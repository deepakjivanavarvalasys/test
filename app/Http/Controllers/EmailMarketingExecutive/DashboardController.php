...
class DashboardController extends Controller
{
    ...
    {
         return view('email_marketing_executive.dashboard',$this->data);
    }


    public function getCountsEME(Request $request)
    {
        $startdate=$request->startdate;
       $enddate=$request->enddate;
        //get RATL's Campaigns
        $resultMyCampaigns = CampaignAssignEME::where('user_id', Auth::id())->whereIn('status', [0,1])->get();
