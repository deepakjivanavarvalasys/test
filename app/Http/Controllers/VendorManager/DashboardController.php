...
class DashboardController extends Controller
{
    ...
    {
         return view('vendor_manager.dashboard',$this->data);
    }


    public function getCountsVM(Request $request)
    {
        $startdate=$request->startdate;
        $enddate=$request->enddate;
     
        //get RATL's Campaigns
        $resultMyCampaigns = CampaignAssignVendorManager::where('user_id', Auth::id())->whereIn('status', [0,1])->get();
