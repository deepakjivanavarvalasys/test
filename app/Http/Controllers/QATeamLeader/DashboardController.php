...
class DashboardController extends Controller
{
    ...
    {
         return view('qa_team_leader.dashboard',$this->data);
    }


    public function getCountsQATL(Request $request)
    {
        $startdate=$request->startdate;
       $enddate=$request->enddate;
        //get RATL's Campaigns
        $resultMyCampaigns = CampaignAssignQATL::where('user_id', Auth::id())->whereIn('status', [0,1])->get();
